...
// Have all of this occur in the printer. Fine if printer is large, but should be simple (especially with this central function)
...
//    }
    ...
    private String buildStringFromList(List<String> wordList, IntegerPair match) {
        String result = "";
